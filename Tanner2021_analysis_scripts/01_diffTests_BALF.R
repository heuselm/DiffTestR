...
# load input data
input_long = fread("PXD029625/DIANN_results_BALF/210331_R04_BALF_DIANN1712_LibFree2Pass/Pass2.tsv")
...
study_design = fread("annotation_BALF.csv")
study_design
...
for (i in 1:nrow(pairs)){
  ...
  dir.create(paste0(i, "_", c1, "_vs_", c2, "_BALF"))
  setwd(paste0(i, "_", c1, "_vs_", c2, "_BALF"))
...
diffs = plotDifferentialAbundanceOverview(cRes,
  label_prefix = "01_diffExpr_BALF",
  protein_highlight_tag = NA)
diffs$volcanos

# export combined results
fwrite(cRes[, compartment:="BALF"], "differentialTestingResults_BALF.csv")