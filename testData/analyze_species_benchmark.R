# Species Benchmark Analysis Script
...
#===============================================================================
# EXPLORIS 480 ANALYSIS
#===============================================================================
cat("Processing Exploris480 dataset...\n")

# Create study design for Exploris
exploris_design <- create_study_design("Exploris480.stats.tsv", "Exploris480")
fwrite(exploris_design, "results/Exploris480_study_design.tsv", sep = "\t")
...
fwrite(combined_results, "results/combined_protein_results.tsv", sep = "\t")
...
volcano_plot <- ggplot(combined_results,
  ...
  labs(x = expression(paste("Fold change, ", log[2])),
       ...
       title = "Differential Abundance Analysis: Mix A vs Mix B",
...
ggsave("results/volcano_plots_sidebyside.pdf", volcano_plot, width = 12, height = 6)
ggsave("results/volcano_plots_sidebyside.png", volcano_plot, width = 12, height = 6, dpi = 300)

#===============================================================================
# MA PLOTS - A/B ratio over summed log10 abundance
#===============================================================================
cat("Creating MA plots (ratio vs abundance)...\n")
...
ggsave("results/ma_plots_sidebyside.pdf", ma_plot, width = 12, height = 6)
ggsave("results/ma_plots_sidebyside.png", ma_plot, width = 12, height = 6, dpi = 300)
...
print(summary_stats)
fwrite(summary_stats, "results/summary_statistics.tsv", sep = "\t")

# Species-specific fold changes
cat("\n=== Expected vs Observed Fold Changes ===\n")
...
cat("Generated files:\n")
cat("  - volcano_plots_sidebyside.pdf\n")
cat("  - ma_plots_sidebyside.pdf\n")
cat("  - combined_protein_results.tsv\n")
